...
/**
 * print_class - function prints the class
 *
...
/**
 * print_data - function prints the data
 *
 * @e_ident: A pointer to an array
 */
...
/**
 * print_version - function prints the version
 *
 * @e_ident: A pointer to an array
 */
...
/**
 * print_type - function that Print the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array
 */
...
/**
 * close_elf - function that Closing file.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	fd2 = read(fd1, header, sizeof(Elf64_Ehdr));
	if (fd2 == -1)
	{
		free(header);
		close_elf(fd1);
